...
| Pattern | Skill Level | Summary |
| :--- | :--- | :--- |
| [Pattern Match on Option and Either](./content/published/pattern-option-either-match.mdx) | 🟢 **Beginner** | Use declarative match() combinators to handle optional and error-prone values |
