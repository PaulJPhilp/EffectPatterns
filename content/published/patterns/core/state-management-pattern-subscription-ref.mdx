...
skillLevel: advanced
useCase: concurrent-state-management
summary: >-
  Build observable state that notifies subscribers on changes, enabling
  reactive patterns and state-driven architecture.
tags:
  - state-management
  - reactivity
  - pub-sub
