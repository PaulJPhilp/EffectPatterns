...
useCase: concurrency-coordination
summary: >-
  Use Semaphore to limit the number of concurrent operations, enabling
  connection pooling, API rate limiting, and controlled resource access
  without overload.
tags:
  - concurrency
  - semaphore
...
rule:
  description: >-
    Use Semaphore to limit concurrent access to resources, preventing
    overload and enabling fair resource distribution.
related:
