...
(This stub preserves the old path while directing readers to the new location.) 3. An Anti-Pattern section 4. Either an Explanation or Rationale section 5. TypeScript code that matches the source file
