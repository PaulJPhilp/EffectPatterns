 ...
 */
export class PatternLoader extends Effect.Service<PatternLoader>()(
  "PatternLoader",
  {
    effect: Effect.gen(function* () {
      ...
      const loadPatternsFromJson = (filePath: string) =>
        Effect.gen(function* () {
          ...
          yield* operationLogger.debug("Starting pattern loading", {
            filePath,
          });
          ...
          const loadEffect = Effect.gen(function* () {
            ...
            yield* operationLogger.debug("File read successful", {
              size: content.length,
            });
            ...
            try {
              ...
              yield* operationLogger.error("JSON parse failed", {
          ...
          yield* logger
            .withDuration(startTime, "loadPatternsFromJson")
